...
{
    [DbContext(typeof(GitHubFitnessDbContext))]
    [Migration("20230421154444_PostRebrandCreate")]
    partial class PostRebrandCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.Administrator", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.Coach", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.CoachApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.Exercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.MuscleGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.Workout", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.Exercise", b =>
                {
                    b.OwnsMany("GitHubFitness.Domain.ValueObjects.MuscleGroupId", "MuscleGroupIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("GitHubFitness.Domain.Aggregates.Workout", b =>
                {
                    ...
                    b.OwnsMany("GitHubFitness.Domain.Entities.WorkoutExercise", "WorkoutExercises", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsOne("GitHubFitness.Domain.ValueObjects.RepRange", "RepRange", b2 =>
                                {
